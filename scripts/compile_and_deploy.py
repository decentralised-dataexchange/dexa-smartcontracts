...
async def deploy(web3, private_key: str, account_address: str, contract_path: str) -> None:
    ...
    logger.info(
        f'Attempting to deploy from account: { account_from["address"] }'
    )
...
if __name__ == "__main__":
    ...
    account_address = str(os.environ.get("ETH_ACCOUNT_ADDRESS"))
